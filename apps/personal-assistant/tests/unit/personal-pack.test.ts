...
describe("buildPersonalSupervisorPack", () => {
  it("buildRuntimeExecution resolves system-config tools for the configuration agent", () => {
    ...
    const { runtimeAgentPolicy } = pack.buildRuntimeExecution!(runtimeAgents, skillCatalog);
