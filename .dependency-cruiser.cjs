...
module.exports = {
  forbidden: [
    ...
    // monorepo layer rules
    {
      ...
      comment:
        'Packages must not depend on apps. Apps are consumers; packages are shared libraries.',
      severity: 'error',
      from: { path: '^packages/' },
      to: { path: '^apps/' },
    },
    {
      name: 'supervisor-framework-not-to-llm-gemini',
      comment:
        'supervisor-framework is the base layer and must not depend on llm-gemini.',
      severity: 'error',
      from: { path: '^packages/supervisor-framework/' },
      to: { path: '^packages/llm-gemini/' },
    },
    {
      name: 'personal-assistant-not-to-minimal-supervisor',
      comment: 'Apps must not import from other apps.',
      severity: 'error',
      from: { path: '^apps/personal-assistant/' },
      to: { path: '^apps/minimal-supervisor/' },
    },
    {
      name: 'minimal-supervisor-not-to-personal-assistant',
      comment: 'Apps must not import from other apps.',
      severity: 'error',
...
// generated: dependency-cruiser@18.1.0 on 2026-07-30T07:42:08.384Z
