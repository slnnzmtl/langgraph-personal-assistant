---
name: cron
description: Manage cron scheduled jobs — list, create, and delete background schedules.
---

# Skill: Cron Job Management

Valid target routes: `Finance_SG`, `Obsidian_SG`, `Config_SG`.
...
2. CREATE (create, add, schedule, set up):
   ...
   - If the user requests a daily note schedule, use:
     - jobName: `daily-note`
     - schedule: `0 6 * * *`
